...
import { PaymentDialog } from "@/pages/purchases/components/payment-dialog";
import {
  PurchasePaymentStatusBadge,
  PurchaseStatusBadge,
} from "@/pages/purchases/components/purchase-badges";
import { PurchaseFlowCard } from "@/pages/purchases/components/purchase-flow-card";
...
export default function ViewPurchase() {
  ...
  const {
    ...
    isValidating,
    mutate: refresh,
  } = useSWR(id ? (["purchase-detail", id] as const) : null, ([, purchaseId]) =>
  ...
  return (
    <div>
      ...
      <div className="relative grid min-w-0 gap-6 xl:grid-cols-3">
        <div className="min-w-0 space-y-6 xl:absolute xl:inset-y-0 xl:left-0 xl:flex xl:w-[calc(66.666667%_-_0.5rem)] xl:flex-col">
          <Card className="xl:min-h-0 xl:flex-1 xl:overflow-hidden">
            ...
            <CardContent className="p-0 xl:min-h-0 xl:flex-1 xl:overflow-y-auto">
        ...
        <div className="min-w-0 space-y-6 xl:col-start-3">
          <PurchaseFlowCard
            purchase={purchase}
            ...
            <CardContent className="space-y-4">
              <dl className="space-y-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <dd className="min-w-0 break-all text-right font-mono text-sm font-semibold">
                    {purchase.sequenceId}
                  </dd>
                </div>
                <div className="flex items-start justify-between gap-4">
