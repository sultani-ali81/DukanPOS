  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:data-active:bg-primary dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
